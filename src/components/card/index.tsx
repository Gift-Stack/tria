...
const TriaCard: FC<PropsWithChildren> = ({ children }) => {
  return (
    <div className="shadow-card-parent bg-card rounded-2.5xl w-full max-w-[458px] p-0.5">
      <div className="bg-surface-black rounded-2.5xl relative h-[80vh] min-h-[550px] w-full pb-2 md:min-h-[840px] md:pb-4">
